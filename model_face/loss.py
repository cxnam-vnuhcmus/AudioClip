...
# mapped_lips_indices = [FACEMESH_LIPS_IDX.index(i) for i in FACEMESH_LIPS_IDX]
mapped_faces_indices = [FACEMESH_FACES_IDX.index(i) for i in FACEMESH_FACES_IDX]
...
class CustomMetric(Metric):
    ...
    def update(self, output):
        ...
        self._num_examples = self._num_examples + flv_score.shape[0] * flv_score.shape[1]
