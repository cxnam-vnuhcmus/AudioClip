...
def convert_emotion_to_one_hot(emotion_label, emotion_level):
    num_classes = len(emotion_to_idx)
    emotion_idx = emotion_to_idx[emotion_label]
    one_hot_vector = torch.zeros(num_classes + 3) 
    one_hot_vector[emotion_idx] = 1 
    one_hot_vector[num_classes + emotion_level - 1] = 1
    return one_hot_vector